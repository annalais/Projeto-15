...
function draw() {
 ...
 if(gameState = PLAY){
  ...
  if(arrowGroup.isTouching(redB) || arrowGroup.isTouching(pinkB) || arrowGroup.isTouching(blueB) || arrowGroup.isTouching(greenB))
{ 
  pontos = pontos + 1
}
  ...
  else if (redB.isTouching(bow) || blueB.isTouching(bow) || pinkB.isTouching(bow) || greenB.isTouching(bow)){
    console.log("hey");
    gameState=END; 
